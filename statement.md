...
* Security vulnerabilities affect everyone: From online banking to airport operation, large parts of everyone's lives have been affected by security vulnerabilities already. With existing technology, up to 70% could have been mitigated from the beginning by applying memory-safe technology.
